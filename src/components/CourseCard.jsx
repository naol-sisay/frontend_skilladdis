...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="group bg-surface rounded-2xl border border-line overflow-hidden flex flex-col card-lift">
      <div className="relative h-44 bg-surface-2 overflow-hidden">
        ...
        />
        <span className="absolute top-3 right-3 bg-surface/95 backdrop-blur text-ink text-sm font-bold px-3 py-1 rounded-full shadow-sm">
      ...
      <div className="p-5 flex-grow flex flex-col">
        ...
        <h3 className="text-lg font-extrabold text-ink mb-2 leading-snug line-clamp-2">
          {course.title}
        </h3>
        <p className="text-sm text-ink-muted line-clamp-2 mb-5 flex-grow">
          {course.description}
        </p>
