        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface border border-line rounded-2xl p-6">
            ...
            <button
              type="button"
              onClick={logout}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-red-200 text-red-600 font-bold hover:bg-red-50 transition-colors"
            >
