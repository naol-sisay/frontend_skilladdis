          ...
          {authed ? (
            <>
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-accent text-white px-8 py-4 rounded-xl font-bold text-lg glow-accent-lg hover:bg-accent-strong hover:-translate-y-0.5 transition-all"
              >
                Go to Dashboard
              </button>
              <button
